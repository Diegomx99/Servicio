...
export class QrComponent implements OnInit {
  ...
  getNombre(nombre){
      this.Nombre = nombre;
      this.qrCodeVal = "Nombre: " + this.Nombre + " " + "Edificio: "+  this.Edificio + " " + "Salon: " + this.Salon + " " + "Cantidad: " + this.Cantidad + " " + "Propietario: " + this.Propietario;
  }
  ...
  */
  ...
  saveAsImage() {
    ...
    fetch(base64Img)
       ...
       .then((blob) => {
          // IE
          blob = new Blob([base64Img], { type: "image/png" });
